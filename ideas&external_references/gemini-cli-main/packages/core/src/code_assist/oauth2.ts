...
// Default value for installed application - can be overridden via environment variable
const OAUTH_CLIENT_ID = process.env['GEMINI_OAUTH_CLIENT_ID'] ||
  '681255809395-oo8ft2oprdrnp9e3aqf6av3hmdib135j.apps.googleusercontent.com';

// OAuth Secret value used to initiate OAuth2Client class.
// Note: For installed applications, this is not treated as a secret per Google's OAuth2 spec:
// https://developers.google.com/identity/protocols/oauth2#installed
// "The process results in a client ID and, in some cases, a client secret,
// which you embed in the source code of your application. (In this context,
// the client secret is obviously not treated as a secret.)"
// Default value provided - can be overridden via GEMINI_OAUTH_CLIENT_SECRET environment variable
const OAUTH_CLIENT_SECRET = process.env['GEMINI_OAUTH_CLIENT_SECRET'] || 'GOCSPX-[REDACTED-USE-ENV-VAR]';
